...
namespace LRMDSp
{
    public partial class LessonPlan2 : UserControl
    {
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            label6.Text = dr.Cells[6].Value.ToString();
        }

        private void LessonPlan2_Load(object sender, EventArgs e)
        {
        ...
        {
            DataTable dt = new DataTable();
            string sql = "Select * from LessonPlan where Title LIKE '%" + textBox1.Text + "%'";
